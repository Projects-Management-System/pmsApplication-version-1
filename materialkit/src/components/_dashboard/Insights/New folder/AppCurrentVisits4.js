...
export default function AppCurrentVisits4({ installationData }) {
  const theme = useTheme();

  // const [InstallationData, setData] = useState([]);
  // useEffect(() => {
  //   axios
  //     .get('https://pms-mobitel.herokuapp.com/vendorProjectsDatabases')
  //     .then((res) => {
  //       setData(res.data.installationDataForFrontEnd);
  //       // console.log(res.data.installationDataForFrontEnd);
  //     })
  //     .catch((err) => {
  //       console.log(err);
  //     });
