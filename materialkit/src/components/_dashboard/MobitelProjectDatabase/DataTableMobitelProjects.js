...
export default function DataTable() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await axiosInstance.get(`/mobitelProjectsDatabasesSiteData?q=${query}`);
  ...
  const deleteUser = async (id) => {
    await axiosInstance.delete(`/mobitelProjectsDatabases/delete/${id}`)
      .catch((err) => {
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <IconButton
                        ...
                        aria-label="edit"
                        color="secondary"
                        href={`DatabasesMobitelProjects/Edit/${post._id}`}
                      >
                        <BorderColorIcon />
                      </IconButton>
                    </TableCell>
