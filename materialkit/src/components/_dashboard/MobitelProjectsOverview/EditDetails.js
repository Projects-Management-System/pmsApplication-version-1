...
import { Button, Card, Container, Stack, Typography, Link, CardHeader } from '@mui/material';
...
export default function EditDetails() {
  ...
  const loadPost = async () => {
    const result = await axiosInstance.get(`/mobitelProjectsOverviewTable/${id}`);
    setPost(result.data.post);
  };

  const onSubmit = async (e) => {
    e.preventDefault();
    await axiosInstance.put(`/mobitelProjectsOverviewTable/Edit/${id}`, post);
